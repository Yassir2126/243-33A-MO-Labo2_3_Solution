 ...
 * @version  V1.0.1
 * @date  2022-03-23
 * @url https://github.com/DFRobot/MOMO_RGB_Matrix
 */
...
// multiple MOMO_RGB_Matrix instances.  The solution at present is to
...
static MOMO_RGB_Matrix *activePanel = NULL;

MOMO_RGB_Matrix::MOMO_RGB_Matrix():
	Adafruit_GFX(64, 32)
{
	MOMO_RGB_MatrixInit(A0,A1,A2,A3,11,10,9,false,64,32);
}


void MOMO_RGB_Matrix::MOMO_RGB_MatrixInit(
...
void MOMO_RGB_Matrix::Write_REG1(int A,int B,int C,int D,uint16_t REG_DATA)
{
...
void MOMO_RGB_Matrix::Write_REG2(int A,int B,int C,int D,uint16_t REG_DATA)
{
  digitalWrite(_sclk, LOW);
  digitalWrite(_latch, LOW);
...
void MOMO_RGB_Matrix::begin(void)
{
...
// Original MOMO_RGB_Matrix library used 3/3/3 color.  Later version used
...
uint16_t MOMO_RGB_Matrix::Color333(uint8_t r, uint8_t g, uint8_t b)
{
	// RRRrrGGGgggBBBbb
...
uint16_t MOMO_RGB_Matrix::Color444(uint8_t r, uint8_t g, uint8_t b)
{
	// RRRRrGGGGggBBBBb
...
uint16_t MOMO_RGB_Matrix::Color888(uint8_t r, uint8_t g, uint8_t b)
{
	return ((uint16_t)(r & 0xF8) << 8) | ((uint16_t)(g & 0xFC) << 3) | (b >> 3);
}

// 8/8/8 -> gamma -> 5/6/5
uint16_t MOMO_RGB_Matrix::Color888(uint8_t r, uint8_t g, uint8_t b, boolean gflag)
{
...
uint16_t MOMO_RGB_Matrix::ColorHSV(long hue, uint8_t sat, uint8_t val, boolean gflag)
{
...
void MOMO_RGB_Matrix::customizeZH(const uint8_t *arr, uint8_t fontSize, uint8_t x, uint8_t y, uint16_t color)
{
...
void MOMO_RGB_Matrix::drawPixel(int16_t x, int16_t y, uint16_t c)
{
...
void MOMO_RGB_Matrix::fillScreen(uint16_t c)
{
...
uint8_t *MOMO_RGB_Matrix::backBuffer()
{
...
void MOMO_RGB_Matrix::swapBuffers(boolean copy)
{
...
void MOMO_RGB_Matrix::dumpMatrix(void)
{
...
void MOMO_RGB_Matrix::updateDisplay(void)
{
