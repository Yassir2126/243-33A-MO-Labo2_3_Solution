...
class MOMO_RGB_Matrix : public Adafruit_GFX {
 ...
 public:
   ...
   *  @brief Constructor
   */ 
  void MOMO_RGB_MatrixInit(uint8_t a, uint8_t b, uint8_t c, uint8_t d,
 ...
 private:
  ...
  void Write_REG1(int A,int B,int C,int D,uint16_t REG_DATA);
  void Write_REG2(int A,int B,int C,int D,uint16_t REG_DATA);
